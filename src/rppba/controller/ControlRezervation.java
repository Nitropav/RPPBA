...
public class ControlRezervation {
    @FXML
    ...
    public void controlRezerv(){
        if (ordersTable.getSelectionModel().getSelectedItem() == null) {
            ...
            ClientInstance.INSTANCE.getInstance().send("notrezervorders " + ordersTable.getSelectionModel().
        ...
        if (ClientInstance.INSTANCE.getInstance().receiveResultBool()) {
            ...
            ChangingFields.display("Ошибка отмены резервации!");
        }
    }
